...
public class QOrder extends EntityPathBase<Order> {
    ...
    private static final long serialVersionUID = -1641638244L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QOrder order = new QOrder("order1");

    public final DateTimePath<java.time.LocalDateTime> close_order_date = createDateTime("close_order_date", java.time.LocalDateTime.class);
